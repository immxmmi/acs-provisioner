"""Base class for all ACS pipeline actions."""
...
class BaseAction(ABC):
    """Abstract base class for all ACS pipeline actions.
    ...
    def __init__(self, gateway=None):
        """
        Args:
            gateway: ACS gateway client to be used by the action.
        """
    ...
    def get_optional(self, data: dict, field: str, default: Any = None) -> Any:
